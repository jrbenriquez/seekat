# Generated by Django 3.1.4 on 2021-01-24 10:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line1', models.CharField(max_length=1024, verbose_name='Address Line 1')),
                ('line2', models.CharField(max_length=1024, verbose_name='Address Line 2')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='se_core.seekat')),
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='seekats', to='se_core.seekataddress')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hashtags', models.ManyToManyField(related_name='seeks', to='se_core.HashTag')),
