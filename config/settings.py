"""
Django settings for seekat project.
...
SECRET_KEY = 'bg_y1l4(m80^&xmzmsbbvvj&h9ff1efk(v3u3cr=xow)h8hjy7'
...
WSGI_APPLICATION = 'seekat.wsgi.application'
